...
//* --------------practice-------------------------
//!1) write a program to find the largest  and second largest in an array 
// const arraynumbers = [23,100,500,80,50,72,502]
// let max = arraynumbers[0]
// let secondmax = arraynumbers[0]
// // console.log(max);
...
// console.log(`secondmax num is ${secondmax}`);

// ! 2) write a program weather a string is palindrome or not 
// const namestr = 'asmaar'
// let newarr = namestr.split('').reverse().join('')
// console.log(newarr);
...
//   // console.log(name[i]);
//   reversestr+=namestr[i]
// }

// console.log(namestr);

// if (namestr === reversestr){
...
//! write a program to counts occurance in an array 
...
// ! write a program to count maximanum numbs of b in an array of strings
// const arr = ["bubble", "abbey", "robot", "banana", "bobble"];

// let maxBCount = 0;
// let resultString = "";

// for (let str of arr) {
//   // Count 'b' in the current string
//   let count = 0;
//   for (let char of str) {
...
//   // Update if this string has more 'b's
//   if (count > maxBCount) {
//     maxBCount = count;
//     resultString = str;
//   }
...
// console.log("String with most 'b's:", resultString);


// const sum = "456".split('').reduce((a, b) => a + +b, 0);
// console.log(sum);
